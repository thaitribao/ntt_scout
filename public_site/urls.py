...
urlpatterns = [
	url(r'^song/index/$', views.song_index, name='song_index'),
	url(r'^song/add_song/$', views.add_song, name='add_song'),
	url(r'^song/(?P<song_slug>[\w\-]+)/$', views.song, name='song'),
	url(r'^song/(?P<song_slug>[\w\-]+)/edit/$', views.edit_song, name='edit_song'),
	url(r'^album/index/$', views.album_index, name='album_index'),
	url(r'^album/add_album/$', views.add_album, name='add_album'),
	url(r'^album/(?P<album_slug>[\w\-]+)/edit/$', views.edit_album, name='edit_album'),
	...
	#url(r'^change_log/$',views.change_log, name='change_log'),
]