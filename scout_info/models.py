...
class Scout_Profile(models.Model):
	...
	khan_tan_sinh = models.URLField(max_length=200, null=True, blank=True)
	khan_hang_nhi = models.URLField(max_length=200, null=True, blank=True)
...
class Camp(models.Model):
	...
	giay_trai = models.URLField(max_length=200, null=True, blank=True)
...
class Item(models.Model):
	...
	note = models.TextField(max_length = 200, null=True, default="")
